...
class MapScreenState extends State<ProfilePage>
  ...
  String email, phoneno, address, serviceName, name;
                    ...
                    new FutureBuilder(
                        future: FirebaseFirestore.instance
                          ...
                          snapshot.docs.forEach((result) async => {
                                ...
                                phoneno = await result.data()['phoneno'],
                                address = await result.data()['address'],
                                email = await result.data()['email'],
                                serviceName = await result.data()['servname'],
                              });
                        }),
  ...
  void saveData() async {
    String addError;
    try {
      await firestoreInstance.collection("users_details").doc(email).update({
        'name': _name.text,
        'email': _email.text,
        'address': _address.text,
        'phoneno': _phoneno.text,
        'servname': _serviceName.text
      });
    } catch (e) {
      addError = e.message;
